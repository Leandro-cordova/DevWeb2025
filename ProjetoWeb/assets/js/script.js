    ...
    function renderTasks(filter)
    {
        ...
        tasks.forEach(function(task, index)
        {
            ...
            li.innerHTML = `
                ...
                <button class="edit"><img class="btnTasks edit" src="assets/img/editar.png"></button>
                <button class="delete"><img class="btnTasks delete" src="assets/img/excluir.png"></button>
            `;
